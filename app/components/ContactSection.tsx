				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:baghelananya96@gmail.com"
							...
							>
								 baghelananya96@gmail.com
							</motion.a>
							<p className="text-green-500 mt-8 mb-2">$ cat resume.pdf</p>
							<motion.a
								href="/resumeML.pdf"
								download="Ananya_Baghel_ML_Engineer_Resume.pdf"
								whileHover={{ scale: 1.02 }}
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@Annaa74</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/ananya-baghel-327307288/"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">Ananya Baghel</p>
									</div>
								</motion.a>
								<motion.a
									href="https://x.com/AnanyaBaghel777"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@AnanyaBaghel777</p>
									</div>
								</motion.a>
								<motion.a
									href="https://open.spotify.com/show/3H5qV6ryqRUEejOK8BnntG"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									...
									<div>
										<p className="font-semibold text-gray-200">Podcast</p>
										<p className="text-sm text-gray-400">House of Turing</p>
									</div>
								</motion.a>
							</div>
						</div>
